...
| 币种分级 | 代表 | 最高杠杆 | 止损 ROI | 单笔最大亏损 |
|---|---|---|---|---|
| Tier A Major | BTC, ETH | **50x** | -5% | 15U |
| Tier A Large | SOL/BNB/XRP/DOGE/ADA/AVAX | **30x** | -8% | 24U |
| Tier B 中盘 | Top 50 其他 | **20x** | -10% | 30U |
| Tier C 山寨 | 其余 | **15x** | -10% | 30U |

**Why**: Hongtou 要求高杠杆 + 团队风险评估折中。大币流动性好可加杠杆,小币波动大需降杠杆。100x 因止损空间过窄 (0.01%) 被正常波动扫损概率 >70%,暂不开放。
**Phase 4 扩展**: 如果 Phase 3 胜率 ≥ 70%,可试 75x BTC; 胜率 ≥ 75% 可试 100x BTC (小仓位 100U)。
