...
class XMRSimpleMonitor:
    ...
    def __init__(self, entry_price=464.65, leverage=10):
...
🎯 止盈位: ${self.take_profit_price:.2f}"""
    ...
    def send_price_update(self, current_price, pnl_data):
        """发送定期价格更新通知"""
        ...
        try:
            while True:
                ...
                if current_price:
                    ...
                    # 发送定期价格更新通知
                    self.send_price_update(current_price, pnl_data)
...
def main():
    """主函数"""
    monitor = XMRSimpleMonitor(entry_price=464.65, leverage=10)
