...
#四色
site = "sise_5s_fs" # 2023-10-06
baidu_userName = "hunao135803"  #账号Asc123456  密码Hz123456 手机 15818500751
...
def baidu(str_comparedate):
    ...
    body = {
        ...
        "metrics":"ip_count",
        "method":"trend/time/a",
        "start_date2":str_comparedate,
        "end_date2":str_comparedate,
        "max_results":"24",
        "gran":"hour",
        "area":""
    }
    ...
    if res.status_code == 200:
        ...
        xData = hours
        yData = today_data
        xyData = {"legend": "今日-" + str_today + site + "-总IP:"+str(sum1), "xData": xData, "yData": yData}
        xyDataList.append(xyData)

        xData = hours
        yData = yesterday_data
        xyData = {"legend": "昨日-" + str_yesterday + site + "-总IP:"+str(sum2), "xData": xData, "yData": yData}
        xyDataList.append(xyData)

        save_path = "baidu_ips"+site+".jpg"
        plot_save(xyDataList, save_path)
        img = open(save_path, 'rb')

        #chat_id = "-740176519"  # maomi_运维对接
