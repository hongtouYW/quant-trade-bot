...
export default function PrivacyContent() {
  ...
  return (
    <div className="min-h-dvh w-full bg-white text-black">
      ...
      {/* ====== SECTION 1 ====== */}
      <section id="privacy-collection" className="w-full bg-white">
      ...
      {/* ====== SECTION 2 ====== */}
      <section id="privacy-usage" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      {/* ====== SECTION 3 ====== */}
      <section id="privacy-protection" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      {/* ====== SECTION 4 ====== */}
      <section id="privacy-sharing" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      {/* ====== SECTION 5 ====== */}
      <section id="privacy-rights" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
