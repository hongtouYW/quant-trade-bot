...
export default function TermsContent() {
  ...
  return (
    <div className="min-h-dvh w-full bg-white text-black">
      ...
      {/* ====== SECTION 1 ====== */}
      <section id="terms-acceptance" className="w-full bg-white">
      ...
      {/* ====== SECTION 2 ====== */}
      <section id="terms-eligibility" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      {/* ====== SECTION 3 ====== */}
      <section id="terms-account" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      {/* ====== SECTION 4 ====== */}
      <section id="terms-restrictions" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      {/* ====== SECTION 5 ====== */}
      <section id="terms-modifications" className="w-full bg-white">
        <div className="mx-auto max-w-4xl px-4 py-6">
