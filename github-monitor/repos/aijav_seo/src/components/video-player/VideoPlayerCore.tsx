...
export function VideoPlayerCore({
  ...
  // During SSR, render a static poster image instead of the browser-only Vidstack player
  if (isSSR) {
    const posterSrc = videoContent.preview || videoContent.thumb || "";
    return (
      <div className="w-full aspect-video bg-black rounded-lg overflow-hidden relative">
        {posterSrc && (
          <img
            src={posterSrc}
            alt={videoContent.title || "Video poster"}
