...
import { buildAuthLoginUrl } from "@/lib/auth-token-url";
                    ...
                    >
                      ...
                      <div className="w-full h-full rounded-lg flex items-center justify-center overflow-hidden">
                        <QRCode
                          size={165}
                          value={
                            user?.username && user?.ori_password && typeof window !== "undefined"
                              ? buildAuthLoginUrl(user.username, user.ori_password)
                              : ""
                          }
