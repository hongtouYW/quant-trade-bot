...
class Vip extends Model
{
    ...
    const info_field  = 'id,title,title_en,title_ru,title_ms,title_th,title_es,des,des_en,des_ru,des_ms,des_th,des_es,day,diamonds,points,cost,money,is_sale,hot,recommend';
    const list_field  = 'id,title,title_en,title_ru,title_ms,title_th,title_es,des,des_en,des_ru,des_ms,des_th,des_es,day,diamonds,points,cost,money,is_sale,hot,recommend';
    protected $hidden = ['title_en','title_ru','title_ms','title_th','title_es','des_en','des_ru','des_ms','des_th','des_es'];
    // const info_field  = 'id,title,title_en,title_ru,des,des_en,des_ru,day,cost,money,is_sale,diamonds,points';
