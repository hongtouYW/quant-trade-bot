...
interface PublisherListSkeletonProps {
...
export const PublisherListSkeleton = ({
  showAnimation = true,
  sectionTitle,
  sectionIcon,
  sectionAction,
}: PublisherListSkeletonProps) => {
  return (
    <div>
      {/* Header Section */}
      ...
      {/* Grid Layout - matching my-publisher-list.tsx grid structure */}
        ...
        {Array.from({ length: 30 }).map((_, index) => (
          ...
          >
            ...
            <div className="flex flex-col w-full items-center gap-1 justify-center">
              ...
              {/* Video count skeleton - hidden in my-publisher-list but keeping for consistency */}
              {/* <Skeleton
