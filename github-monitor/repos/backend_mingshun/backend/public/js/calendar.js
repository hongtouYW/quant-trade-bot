var gcObject = {
    options: (options = {
      ...
      events: [{ date: null, eventName: null, dayClassName: null, className: null, onclick: function (ev, data) {}, dateColor: "#38385c" }],
      ...
      calendarData.forEach(function (e) {
        ...
        e.forEach(function (e) {
          ...
          cell.click(function (ev) {
            gcObject.options.onclickDate(ev, e, cell);
          });
          cell.appendTo(row);
          ...
          gcObject.options.events.forEach(function (evt) {
            if (
              ...
              cell.append(event);
              $(cell).addClass(evt.dayClassName);
            }
          });
  ...
  (function ($) {
    $.fn.calendarGC = function (
      ...
      gcObject.options.onMonthPrevNext = options.onMonthPrevNext || function (e) {};
