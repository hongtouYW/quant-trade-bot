...
import com.dj.manager.notify.helpers.BitmapHelper;
import com.dj.manager.notify.helpers.ResourcesHelper;
...
public class Notify {
    ...
    public interface ChannelData {
        String
                ...
                NOTIFICATION = "notify_channel_notification";
    }
    ...
    private String channelNotification;
    ...
    private Notify(Context _context) {
        ...
        channelNotification = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION).toString();
//        try {
//            this.channelNotification = ResourcesHelper.getStringResourceByKey(context, ChannelData.NOTIFICATION);
//        } catch (Resources.NotFoundException e) {
//
//        }
    ...
    public void show() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            for (int i = 0; channelList != null && i < channelList.size(); i++) {
                if (!channelList.get(i).getId().equalsIgnoreCase("ForegroundServiceChannel")) {
...
//                .setDefaults(Notification.DEFAULT_SOUND)
        ...
        if (SDK_INT >= Build.VERSION_CODES.O) {
            ...
            AudioAttributes audioAttributes = new AudioAttributes.Builder()
                    ...
                    .build();
            notificationChannel.setSound(Uri.parse(channelNotification), audioAttributes);
        ...
        if (this.action != null) {
            ...
            if (SDK_INT >= M)
                pi = PendingIntent.getActivity(context, id, this.action,
                    ...
                    this.action, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public Notify setChannelNotification(@NonNull String channelNotification) {
