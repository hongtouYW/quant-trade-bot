...
@section('title', __('notification.add_new_notification'))
@section('header-title', __('notification.add_new_notification'))
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>{{ __('notification.add_new_notification') }}</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
                <form action="{{ route('admin.notification.store') }}" method="POST" class="p-4">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notification_desc') is-invalid @enderror" id="notification_desc" name="notification_desc" maxlength="1000" style="height: 100px;">{{ old('notification_desc') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('notification_type') is-invalid @enderror" id="notification_type" name="notification_type">
                            ...
                            @foreach ($types as $type)
                                <option value="{{ $type }}" {{ old('notification_type') == $type ? 'selected' : '' }}>
