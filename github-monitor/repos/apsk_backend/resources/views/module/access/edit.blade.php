...
@section('title', __('module.access_management'))
@section('header-title', __('module.access_management'))
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex">
                    <h6>{{ __('role.edit_access') }}: {{ $user_role }}</h6>
                    {{-- Global select all --}}
                ...
                <div class="card-body px-0 pt-0 pb-2 container">
                    <form action="{{ route('admin.access.update', $user_role) }}" method="POST" class="p-4">
                        @csrf
                        @method('PUT')
