...
@section('title', __('role.add_new_role'))
@section('header-title', __('role.add_new_role'))
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>{{ __('role.add_new_role') }}</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
                <form action="{{ route('admin.role.store') }}" method="POST" class="p-4">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('role_desc') is-invalid @enderror" id="role_desc" name="role_desc" maxlength="1000" style="height: 100px;">{{ old('role_desc') }}</textarea>
                        @error('role_desc')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
