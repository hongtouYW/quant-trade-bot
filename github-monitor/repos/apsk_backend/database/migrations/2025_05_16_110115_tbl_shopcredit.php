...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_shopcredit', function (Blueprint $table) {
            $table->bigIncrements('shopcredit_id')->comment('店铺流水ID');
            ...
            $table->string('type', 50)->comment('交易类型 提现/充值 withdraw/deposit');
    ...
    {
        Schema::dropIfExists('tbl_shopcredit');
    }
};
