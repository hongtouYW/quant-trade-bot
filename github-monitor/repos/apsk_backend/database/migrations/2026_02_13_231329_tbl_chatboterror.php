...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_chatboterror', function (Blueprint $table) {
            $table->bigIncrements('chatboterror_id')->primary()->comment('错误ID');
            $table->string('api')->comment('API链接');
            $table->longText('request')->nullable()->comment('请求json');
    ...
    {
        Schema::dropIfExists('tbl_chatboterror');
    }
};
