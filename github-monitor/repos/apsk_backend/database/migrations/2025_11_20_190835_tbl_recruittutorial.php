...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_recruittutorial', function (Blueprint $table) {
            $table->bigIncrements('recruittutorial_id')->comment('推广教程ID');
            $table->string('title', 50)->comment('主題');
            $table->longText('picture')->nullable()->collation('utf8mb4_unicode_ci')->comment('图片');
            $table->string('slogan', 50)->comment('口号');
    ...
    {
        Schema::dropIfExists('tbl_recruittutorial');
    }
};
