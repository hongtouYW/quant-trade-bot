...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_providerbookmark', function (Blueprint $table) {
            $table->bigIncrements('providerbookmark_id')->comment('供应商收藏ID');
            $table->string('providerbookmark_name')->comment('供应商收藏名字');
    ...
    {
        Schema::dropIfExists('tbl_providerbookmark');
    }
};
