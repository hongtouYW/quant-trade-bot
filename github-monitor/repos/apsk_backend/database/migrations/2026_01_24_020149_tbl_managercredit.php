...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_managercredit', function (Blueprint $table) {
            $table->bigIncrements('managercredit_id')->primary()->comment('经理流水ID');
            $table->unsignedBigInteger('manager_id')->comment('经理ID');
            $table->unsignedBigInteger('user_id')->comment('管理ID');
    ...
    {
        Schema::dropIfExists('tbl_managercredit');
    }
};
