...
class Rsa
{
     ...
     */
    // public function initt($public_key = '', $private_key = '')
    // {
    //     if ($public_key) {
    ...
    // {
    //     $this->priKey = openssl_get_privatekey($file);
    // }
     ...
     * @return array
     */
    public function generate(int $private_key_bits = 4096)
    {
        $rsa = [
            "private_key" => "",
            "public_key" => ""
    ...
    public function sign($data, $private_key, $code = 'base64')
    {
        ...
        $ret = false;
        if (openssl_sign($data, $ret, $private_key)) {
     ...
     * @return bool
     */
    public function verify($data, $public_key, $sign, $code = 'base64')
    {
     ...
     * @return string 密文
     */
    public function encrypt($data, $private_key, $code = 'base64', $padding = OPENSSL_PKCS1_PADDING)
    {
        //$public_key = openssl_get_publickey($public_key);
        $private_key = openssl_get_privatekey($private_key);
        $ret = false;
     ...
     * @return string 明文
     */
    public function decrypt($data, $public_key, $code = 'base64', $padding = OPENSSL_PKCS1_PADDING, $rev = false)
    {
        //$private_key = openssl_get_privatekey($private_key);
        $public_key = openssl_get_publickey($public_key);
        //return $private_key;
