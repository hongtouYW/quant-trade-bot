...
class Report extends Controller
{
    ...
    public function record(){
        ...
        $yes_profit = $orderModel::whereTime('pay_time','yesterday')->where('status','=',1)->sum('money');
        ...
        $before_yes_profit = $orderModel::whereTime('pay_time', [$before_yes_start, $before_yes_end])->where('status','=',1)->sum('money');
