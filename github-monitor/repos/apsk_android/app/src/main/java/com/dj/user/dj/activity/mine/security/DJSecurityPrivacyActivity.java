...
import com.dj.user.databinding.DjActivitySecurityPrivacyBinding;
...
public class DJSecurityPrivacyActivity extends BaseActivity {

    private DjActivitySecurityPrivacyBinding binding;
    private Member member;
    private DJProfileSectionListViewAdapter memberAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DjActivitySecurityPrivacyBinding.inflate(getLayoutInflater());
    ...
    private void setupActionList() {
        memberAdapter = new DJProfileSectionListViewAdapter(this);
        ...
        memberAdapter.setOnItemClickListener((position, object) -> {
            ...
            switch (clicked.getId()) {
                case 1:
                    startAppActivity(new Intent(DJSecurityPrivacyActivity.this, DJBindPhoneActivity.class),
                            null, false, false, true);
                    break;
                case 2:
                    startAppActivity(new Intent(DJSecurityPrivacyActivity.this, DJBindEmailActivity.class),
                            null, false, false, true);
                    break;
                case 3:
                    startAppActivity(new Intent(DJSecurityPrivacyActivity.this, DJBindAuthenticatorActivity.class),
                            null, false, false, true);
                    break;
                case 4:
                    startAppActivity(new Intent(DJSecurityPrivacyActivity.this, DJBiometricActivity.class),
                            null, false, false, true);
                    break;
                case 5:
                    startAppActivity(new Intent(DJSecurityPrivacyActivity.this, DJUpdatePasswordActivity.class),
                            null, false, false, true);
                    break;
            }
        });
    ...
    private void getProfile() {
        ...
        executeApiCall(this, apiService.getProfile(request), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<Member> response) {
                ...
                if (member != null) {
                    CacheManager.saveObject(DJSecurityPrivacyActivity.this, CacheManager.KEY_USER_PROFILE, member);
                    refreshActionList();
                }
            }
