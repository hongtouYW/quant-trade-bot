...
import com.dj.user.databinding.ViewRoundedEditTextBinding;
...
public class RoundedEditTextView extends FrameLayout {
    ...
    public void setInputFieldType(InputFieldType type) {
        switch (type) {
            ...
            case MULTILINE_TEXT_LONG:
                ...
                binding.editText.setPadding(0, FormatUtils.dpToPx(getContext(), 12), 0, FormatUtils.dpToPx(getContext(), 12));
                binding.endButton.setVisibility(GONE);
    ...
    public void setEditTextHeight(int heightInDp) {
        binding.editText.getLayoutParams().height = FormatUtils.dpToPx(getContext(), heightInDp);
    ...
    public void showError(String errorMsg) {
        if (isTransparentBackground) {
            editTextContainer.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.bg_edit_text_transparent_error));
        } else {
    ...
    public void clearError() {
        if (isTransparentBackground) {
            editTextContainer.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.bg_edit_text_transparent));
        } else {
    ...
    public void setTextSize(float sizeSp) {
        binding.editText.setTextSize(sizeSp);
    }
