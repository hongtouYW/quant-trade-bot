...
public class ProfileSectionListViewAdapter extends CustomAdapter<ItemSection> {
    ...
    public ProfileSectionListViewAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_list_section, parent, false);
