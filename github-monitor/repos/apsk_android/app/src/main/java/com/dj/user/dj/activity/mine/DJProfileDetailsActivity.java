package com.dj.user.dj.activity.mine;
...
import com.dj.user.databinding.DjActivityProfileDetailsBinding;
...
public class DJProfileDetailsActivity extends BaseActivity implements CalendarBottomSheetDialogFragment.DateSelectionListener {

    private DjActivityProfileDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DjActivityProfileDetailsBinding.inflate(getLayoutInflater());
    ...
    private void setupViewData() {
        ...
        binding.textViewId.setText(member.getMember_id());
    ...
    private void getProfile() {
        ...
        executeApiCall(this, apiService.getProfile(request), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<Member> response) {
                ...
                if (member != null) {
                    CacheManager.saveObject(DJProfileDetailsActivity.this, CacheManager.KEY_USER_PROFILE, member);
                }
                setupViewData();
            }
    ...
    private void editProfile() {
        ...
        executeApiCall(this, apiService.editProfile(request), new ApiCallback<>() {
            @Override
            public void onSuccess(BaseResponse<Member> response) {
                CustomToast.showTopToast(DJProfileDetailsActivity.this, getString(R.string.profile_saved_successfully));
                member = response.getData();
                if (member != null) {
                    CacheManager.saveObject(DJProfileDetailsActivity.this, CacheManager.KEY_USER_PROFILE, member);
                }
