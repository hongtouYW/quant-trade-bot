...
import com.dj.user.databinding.DjActivityUpdatePasswordOtpBinding;
...
public class DJUpdatePasswordOTPActivity extends BaseActivity {

    private DjActivityUpdatePasswordOtpBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DjActivityUpdatePasswordOtpBinding.inflate(getLayoutInflater());
        ...
        executeApiCall(this, apiService.changePasswordRequestOTP(request), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<Void> response) {
                ...
                if (!StringUtil.isNullOrEmpty(otp)) {
                    Toast.makeText(DJUpdatePasswordOTPActivity.this, "Testing: " + otp, Toast.LENGTH_LONG).show();
                }
    ...
    private void gotoNextScreen() {
        ...
        Intent intent = new Intent(this, DJSecurityPrivacyActivity.class);
