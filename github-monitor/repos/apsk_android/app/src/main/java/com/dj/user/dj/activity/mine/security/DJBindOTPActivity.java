...
import com.dj.user.databinding.DjActivityBindOtpBinding;
...
public class DJBindOTPActivity extends BaseActivity {

    private DjActivityBindOtpBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DjActivityBindOtpBinding.inflate(getLayoutInflater());
        ...
        executeApiCall(this, apiService.requestBindPhone(bindPhoneRequest), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<Void> response) {
                ...
                if (!StringUtil.isNullOrEmpty(otp)) {
                    Toast.makeText(DJBindOTPActivity.this, "Testing: " + otp, Toast.LENGTH_LONG).show();
                }
    ...
    private void bindPhone() {
        ...
        executeApiCall(this, apiService.bindPhone(request), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<Member> response) {
                CustomToast.showTopToast(DJBindOTPActivity.this, getString(R.string.bind_otp_success_phone));
                Intent intent = new Intent(DJBindOTPActivity.this, DJSecurityPrivacyActivity.class);
    ...
    private void bindEmail() {
        ...
        executeApiCall(this, apiService.bindEmail(request), new ApiCallback<>() {
            @Override
            public void onSuccess(BaseResponse<Member> response) {
                CustomToast.showTopToast(DJBindOTPActivity.this, getString(R.string.bind_otp_success_email));
                Intent intent = new Intent(DJBindOTPActivity.this, DJSecurityPrivacyActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
