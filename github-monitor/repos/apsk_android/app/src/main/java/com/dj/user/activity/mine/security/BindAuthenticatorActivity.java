...
import com.dj.user.databinding.ActivityBindAuthenticatorBinding;
...
public class BindAuthenticatorActivity extends BaseActivity {

    private ActivityBindAuthenticatorBinding binding;
    private Member member;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityBindAuthenticatorBinding.inflate(getLayoutInflater());
        ...
        executeApiCall(this, apiService.getGoogleAuthenticatorInfo(request), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<GoogleAuthenticator> response) {
                ...
                if (googleAuthenticator != null) {
                    Bitmap bitmap = ImageUtils.generateQRCode(BindAuthenticatorActivity.this, googleAuthenticator.getQr());
                    if (bitmap != null) {
                        ...
                        binding.imageViewQr.setOnClickListener(v -> {
                            ...
                            startAppActivity(new Intent(BindAuthenticatorActivity.this, FullScreenImageActivity.class),
                                    bundle, false, false, true);
                        });
                        binding.panelCopy.setOnClickListener(view ->
                                StringUtil.copyToClipboard(BindAuthenticatorActivity.this, "Shared Secret", googleAuthenticator.getSecret())
                        );
                    }
                }
            }
    ...
    private void bindUnbindGoogleAuthenticator() {
        ...
        executeApiCall(this, apiService.bindGoogle(request), new ApiCallback<>() {
            ...
            public void onSuccess(BaseResponse<Member> response) {
                CustomToast.showTopToast(BindAuthenticatorActivity.this, isBinded ? getString(R.string.google_authentication_success_unbind) : getString(R.string.google_authentication_success_bind));
                Intent intent = new Intent(BindAuthenticatorActivity.this, SecurityPrivacyActivity.class);
