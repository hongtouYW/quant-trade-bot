...
import com.dj.user.databinding.DjActivityBiometricBinding;
...
public class DJBiometricActivity extends BaseActivity {

    private DjActivityBiometricBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DjActivityBiometricBinding.inflate(getLayoutInflater());
                ...
                new BiometricPrompt.AuthenticationCallback() {
                    ...
                    public void onAuthenticationSucceeded(@NonNull BiometricPrompt.AuthenticationResult result) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            CustomToast.showTopToast(DJBiometricActivity.this, getString(R.string.biometric_success_enabled));
                    ...
                    public void onAuthenticationFailed() {
                        ...
                        runOnUiThread(() -> {
                            isAuthenticating = false;
                            Toast.makeText(DJBiometricActivity.this, R.string.biometric_failed, Toast.LENGTH_SHORT).show();
                        });
                    }
                    ...
                    public void onAuthenticationError(int errorCode, @NonNull CharSequence errString) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            if (errorCode == BiometricPrompt.ERROR_NO_BIOMETRICS) {
                                Toast.makeText(DJBiometricActivity.this, getString(R.string.biometric_not_setup), Toast.LENGTH_LONG).show();
                                startActivity(new Intent(Settings.ACTION_SECURITY_SETTINGS));
                            } else if (errorCode != BiometricPrompt.ERROR_USER_CANCELED) {
                                Toast.makeText(DJBiometricActivity.this, String.format(getString(R.string.template_s_space_s), getString(R.string.biometric_failed), errString), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
