...
import com.dj.user.databinding.DjFragmentHomeBinding;
...
public class DJHomeFragment extends BaseFragment {

    private DjFragmentHomeBinding binding;
    ...
    private DJSongListFragment remixSongListFragment;
    private DJSongListFragment singleSongListFragment;
    private DJSongListFragment historySongListFragment;
    ...
    public DJHomeFragment newInstance(Context context) {
        DJHomeFragment fragment = new DJHomeFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DjFragmentHomeBinding.inflate(inflater, container, false);
        context = getContext();
    ...
    private void setupYxiViewPager() {
        remixSongListFragment = new DJSongListFragment().newInstance(context, TAB_REMIX);
        singleSongListFragment = new DJSongListFragment().newInstance(context, TAB_SINGLE);
        historySongListFragment = new DJSongListFragment().newInstance(context, TAB_HISTORY);
