...
public class CreditListViewAdapter extends CustomAdapter<Transaction> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (transaction != null) {
            CreditTransactionType type = transaction.getTransactionType();
            ...
            if (type != null) {
                ...
                String title = !StringUtil.isNullOrEmpty(transaction.getTitle()) ? transaction.getTitle() : context.getString(type.getTitle());
                viewHolder.titleTextView.setText(String.format(context.getString(R.string.template_s_s_rm_s), title, type.getSymbol(), FormatUtils.formatAmount(transaction.getAmount())));
