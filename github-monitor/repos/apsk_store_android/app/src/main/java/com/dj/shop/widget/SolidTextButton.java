...
public class SolidTextButton extends AppCompatButton {

    public SolidTextButton(Context context) {
        super(context);
        init(context);
    }

    public SolidTextButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SolidTextButton(Context context, AttributeSet attrs, int defStyleAttr) {
