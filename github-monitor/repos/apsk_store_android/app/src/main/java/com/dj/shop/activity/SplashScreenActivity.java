...
import com.dj.shop.util.InAppUpdater;
...
public class SplashScreenActivity extends BaseActivity {
    ...
    protected void proceedToNextScreen() {
        if (isLoggedIn()) {
            startAppActivity(new Intent(SplashScreenActivity.this, DashboardActivity.class),
                    null, true, true, true
            );
        } else {
            startAppActivity(new Intent(SplashScreenActivity.this, LoginActivity.class),
                    null, true, true, true
            );
        }
    }

    protected void showUpdateDialog(boolean forceUpdate, @NonNull String latestVersion, @Nullable String changeLog, @Nullable String url) {
...
//                                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url)));
        ...
        bottomSheet.show(getSupportFragmentManager(), "VersionBottomSheet");
    }
